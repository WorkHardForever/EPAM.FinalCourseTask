...
test('when dragging and cancel gets called, nothing happens',
    function(t) {
...
test('when dragging and cancel gets called, cancel event is emitted',
    function(t) {
        var div = document.createElement('div');
        var item = document.createElement('div');
        var drake = dragula([div]);
...
test('when dragging a copy and cancel gets called, default does not revert',
    function(t) {
        var div = document.createElement('div');
...
test('when dragging a copy and cancel gets called, revert is executed',
    function(t) {
        var div = document.createElement('div');
        var div2 = document.createElement('div');
        var item = document.createElement('div');
