    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Profiles", t => t.Manager_Id)
                .ForeignKey("dbo.Profiles", t => t.Employee_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Tasks", "Employee_Id", "dbo.Profiles");
            DropForeignKey("dbo.Tasks", "Manager_Id", "dbo.Profiles");
